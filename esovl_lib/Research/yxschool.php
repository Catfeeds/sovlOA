...
<div class="main_box02">  
     ...
     <div class="main_box001">
         ...
         <div class="yx_s002">
		<ul><li><a href="yxschool_kcjs.php?con=kc">课程介绍</a></li><li><a href="yxschool_kcjs.php?con=xw">学位与证书</a></li><li><a href="yxschool_kcjs.php?con=zs">招生对象</a></li><li><a href="yxschool_kcjs.php?con=sz">师资配备</a></li><li><a href="yxschool_kcjs.php?con=kcsz">课程设置</a></li><li><a href="yxschool_kcjs.php?con=bmxz">报名须知</a></li><li><a href="yxschool_kcjs.php?con=cailiao">申请所需材料</a></li><li><a href="yxschool_zxwd.php">在线问答</a></li><li><a href="#">本校其他课程</a></li></ul>
         </div>
         <div class="yx_s003">
            <div class="yx_s003_left">
            <div class="yx_l_title">课程介绍</div>
            <div class="yx_l_con"><?=$Common->strCutAndTags($rowb["school_kc"],300,'..')?></div>
            <div class="yx_l_title">课程设置</div>
            <div class="yx_l_con"><?=$Common->strCutAndTags($rowb["school_kcsz"],400,'..')?></div>
            <div class="yx_l_title">师资配备</div>
            <div class="yx_l_con"><?=$Common->strCutAndTags($rowb["school_sz"],400,'..')?></div>
              ...
              <table cellspacing="1" cellpadding="2" width="90%" align="left" bgcolor="#ACACAC" border="0">
                <tbody>
                  <tr>
                    ...
                    <td width="85%" bgcolor="#ffffff"><?=$rowb["yxk_time"]?></td>
                  </tr>
                  <tr>
                    <td align="right" bgcolor="#E8E8E8" height="25">上课地点:</td>
                    <td bgcolor="#ffffff"><?=$rowb["yxk_adder"]?></td>
                  </tr>
                  <tr>
                    <td align="right" bgcolor="#E8E8E8" height="25">开课名称:</td>
                    <td bgcolor="#ffffff"><?=$rowb["yxk_title"]?></td>
                  </tr>
                </tbody>
              </table>
            </div>
				...
				<div class="yx_l_con">
					<form name="bmform" method="post" onSubmit="return newsset()" action="">
					  <p>昵称：<input name="wd_name" type="text"/> 您尚未登陆，将以游客身分留言。<label id="wdname"></label>[<a href="<?=$z_website?>vip_login.php">登陆</a>] [<a href="<?=$z_website?>vip_zc.php">注册</a>]</p>
            ...
            <div class="yx_s003_right">
                 ...
                 <div class="yx_s004_top">
                    ...
                    <div class="yx_kkxx_list">
                     <ul>
						<?php
						$rowc=$dblink->findAll("yx_kaike",array(),"yxk_school={$rowb["yxk_school"]}",'','9','yxk_id desc');
						   foreach($rowc as $v){
						?>
