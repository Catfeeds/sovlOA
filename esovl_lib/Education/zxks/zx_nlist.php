...
<title>学历教育-<?=$ction?></title>
<meta name="keywords" content="<?=$zx_keyword?>" />
<meta name="description" content="<?=$zx_contant?>" />
...
?>
                  <div class="zx_xw_dk">
                    <div class="zx_xw_tu"><img src="../../admin_root/<?=$row["npic"]?>" alt=<?=$row["ntitle"]?>/></div>
                    <div class="zx_xw_bt"><a href="Education/zxks/zx_nlist_detail.php?id=<?=$row["nid"]?>">
                      <?=$row["ntitle"]?>
                      </a></div>
                    ...
                    <div class="zx_xw_nr">
                      <?=msubstr(strip_tags($row["ncon"]),170)?>
                      .. </div>
                  </div>
                  <?php }else{?>
                  <div class="zx_xw_dk2">
                    <div class="zx_wzgg_bt"><span><a href="Education/zxks/zx_nlist_detail.php?id=<?=$row["nid"]?>">
                      <?=$row["ntitle"]?>
                      </a></span>
                      <?=date('Y-m-d',strtotime($row["ndate"]))?>
                    </div>
                    <div class="zx_wzgg_nr">
                      ...
                      .. <span><a href="Education/zxks/zx_nlist_detail.php?id=<?=$row["nid"]?>">查看详细>></a></span></div>
                  </div>
                  <?php }}}?>
	 ...
	 while ($row=mysql_fetch_array($rs,MYSQL_ASSOC)){
		 ...
		 // if ($rowb["bk_id"]==1){
			 ?>
                  <div class="wl_hd">
                    <ul>
                      <li><span>[问]</span><a href="Education/xl_pro_zxtw.php?kid=<?=$row6["kid"]?>&sid=<?=$row6["s_id"]?>">
                        <?=$row["wd_ask"]?>
                        ...
                        <?=date('Y-m-d',strtotime($row["wd_stime"]))?>
                        </a></li>
                      <li><span>[答]</span>
                        <?=$row["wd_answer"]?>
                        ...
                        <?=date('Y-m-d',strtotime($row["wd_ltime"]))?>
                      </li>
                    </ul>
                  </div>
                  <?php }}?>
