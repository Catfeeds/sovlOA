...
<meta name="keywords" content="<?=$xl_keyword?>" />
<meta name="description" content="<?=$xl_contant?>" />
...
for(var i=1;i<=3;i++){g('tb_'+i).className='normaltab1';g('tbc_0'+i).className='undis';}g('tbc_0'+n).className='dis';g('tb_'+n).className='hovertab1';
              ...
              <div class="zx_zx_dk">
                  <div class="zx_zx_fd">
                    <div class="zx_zx_lj">
                    	<dl>
                          ...
                          <dt><img src="<?=$z_website?>images/bx_hw_03.jpg" width="17" height="30" /></dt>
                          <dd><a href="<?=$z_website?>Education/zxks/zx_nlist.php?cid=<?=$nclass?>"><?=$ction?></a></dd>
                          <dt><img src="<?=$z_website?>images/bx_hw_03.jpg" width="17" height="30" /></dt>
                          <dd>详细</dd>
                          <dt><img src="<?=$z_website?>images/bx_hw_03.jpg" width="17" height="30" /></dt>
                        </dl>
                  ...
                  <div class="zx_wzgg">
                    ...
                    <div class="zx_xx_fh"><a href="<?=$z_website?>Education/xl_newscl.php?cl=<?=$nclass?>">[返回列表]</a></div>
                  </div>
              </div> 
...
<li><a href=tencent://message/?uin=<?php echo $qq2;?>&Site=<?php echo $z_name;?>&Menu=yes title="在线咨询2"><img border="0" src=http://wpa.qq.com/pa?p=1:<?php echo $qq2;?>:1 align="top"/></a></li>
              ...
              <div class="zx_hw_dk">
                    ...
                    <div class="zx_hw_xw">
						...
						if (mysql_num_rows($rs)>=1){
							while ($row=mysql_fetch_array($rs,MYSQL_ASSOC)){
						?>
                <li><a href="Education/zxks/zx_nlist_detail.php?id=<?php echo $row["nid"];?>" title="<?php echo $row["ntitle"];?>"><?php echo msubstr($row["ntitle"],24)?></a></li>                 
                        <?php
						}}
						?>
                        </ul>
	 ...
	 while ($row=mysql_fetch_array($rs,MYSQL_ASSOC)){ 
      ...
      <?php }}?>
                ...
                <div class="zx_hw_dk">
               	  <div class="zx_hw_bj">
                    	<div class="zx_hw_bt"><span><?=$ction?></span></div>
                    </div>
                    <div class="zx_hw_xian"></div>
                    <div class="zx_hw_xw">
                    	<ul>
                        	<?php
						$sql="select * from ennews where nclass=".$nclass." limit 2,5";
						$rs=mysql_query($sql);
						if (mysql_num_rows($rs)>=1){
							while ($row=mysql_fetch_array($rs,MYSQL_ASSOC)){
						?>
                    <li><a href="Education/xl_news_detail.php?id=<?php echo $row["nid"];?>" title="<?=$row["ntitle"]?>"><?php echo msubstr($row["ntitle"],24)?>..</a></li>
                    <?php
						}}
						?>
                        </ul>
