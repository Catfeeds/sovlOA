...
<title><?php echo $_SESSION["s_name"];?>-表格下载</title>
  ...
  <div class="main_xyjs">
  	<div class="main_xyjs_left">
        ...
        <div class="main_xyjs_left_box">
        	<div class="main_xyjs_left_box_title_zsjz"><?php echo $_SESSION["s_name"];?>--表格下载</div>
			<div class="main_tab">
...
$url=parse_url($url);
@$url=$url[path];
$numq=mysql_query("SELECT * FROM mb_download where w_dclass='表格资料下载' and s_name='".$_SESSION["s_name"]."'");
...
$page.=',';
      ...
      @$sql="select * from mb_download where w_dclass='表格资料下载' and s_name='".$_SESSION["s_name"]."' order by w_id desc limit $page $pagesize ";     
...
?>
<span>
<?php if(isset($_GET["page"])){echo $_GET["page"];}else{echo 1;}?></span>/<span><?php echo $cp;?></span>页，每页显示<span><?php echo $pagesize;?></span>
                </div>
...
<!-- main end -->
<!-- bottom -->
<?php include("mb_bottom.html");?><?php echo $row["title"];?>
<!-- bottom end -->
</div>
</body>
</html>
