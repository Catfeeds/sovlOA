		...
		<div class="main_news">
			<div class="main_news_post00">
				...
				<div class="main_news_post_text">
					<h1><?=$details->i_title?></h1>
					<h2>发表于：<?=$details->i_submitdate?>  作者：<?=$details->i_author?> 浏览：<?=$details->i_click?>次</h2><br />
					<span class="text"><?=$details->i_con?></span>
					<div class="main_news_fhlb">
						<ul>
						  <li><img width="15" height="15" src="/images/top.jpg"><a href="#">TOP</a></li>
						  <li><img width="15" height="15" src="/images/bottom.jpg"><a href="<?=Yii::app()->createUrl("abroad/newslist",array("cl"=>$details->i_class))?>">[返回列表]</a></li>
						</ul>
					</div>
				</div>
			</div>
