			...
			<div class="main_news_sidebar">
				...
				<div class="main_news_sidebar_box01">
					...
					<div class="main_news_sidebar_box01_list">
						...
						?>
						<li><strong>[留学热点]</strong><a href="<?=Yii::app()->createUrl("abroad/vnewsdetail",array("id"=>$row11['vi_id']));?>" title="<?=$row11["vi_title"]?>"><?=Common::strCut(strip_tags($row11["vi_title"]),38)?></a></li>
						<?php }?>
						</ul>
					</div>
				</div>
				...
				<div class="main_news_post_box">
					...
					<div class="main_news_post_box_list">
						...
						<div class="main_news_post_box_list00">
							...
							<dl>
							<dt><a href="<?=Yii::app()->createUrl("abroad/vnewsdetail",array("id"=>$row["vi_id"]))?>" title="<?=$row["vi_title"]?>"><?=$row["vi_title"]?></a></dt>
							<dd><?=date("Y-m-d", strtotime($row["vi_submitdate"]));?></dd>
							</dl>
							</div>
							<div class="main_news_post_box_list00_l"><?=Common::strCut(strip_tags($row["vi_con"]),280)?> <a href="<?=Yii::app()->createUrl("abroad/vnewsdetail",array("id"=>$row["vi_id"]))?>">查看详细>></a>
							</div>
						</div>
