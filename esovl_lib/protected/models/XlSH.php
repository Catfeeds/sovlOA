...
/**
 * This is the model class for table "xl_s_h".
 *
 * The followings are the available columns in table 'xl_s_h':
 ...
 */
class XlSH extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return XlSH the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('classid, s_h_title', 'required'),
			array('classid', 'numerical', 'integerOnly'=>true),
			array('s_h_title, s_h_pic, s_h_http', 'length', 'max'=>200),
