 ...
 * @since 1.0
 */
class CYixiuLinkPager extends CBasePager
{
...
//		for($i=$beginPage;$i<=$endPage;++$i)
			$buttons[]=$this->creagePageNum($beginPage+1,$beginPage,self::CSS_INTERNAL_PAGE,$pageCount);
...
//		$buttons[]=$this->createPageButton($this->lastPageLabel,$pageCount-1,self::CSS_LAST_PAGE,$currentPage>=$pageCount-1,false);
	 ...
	 */
    protected function creagePageNum($label,$page,$class,$pageCount){
        $return  = '<li class="'.$class.'">&nbsp;'.$label.'</li>';
        $return  .= '<li class="'.$class.'">/</li>';
        $return .= '<li class="'.$class.'">'.$pageCount.'&nbsp;</li>';
        return $return;
    }
