...
if (@$_COOKIE["a_class"]>1) {
  ...
  if (isset($_POST["down_title"])){
      $sql="insert into yx_down set down_title='".$_POST["down_title"]."',w_con='".$_POST["w_con"]."'";
	  $rs=mysql_query($sql,$conn);
	  if ($rs){
      echo"<script>alert('信息添加成功');location.href='yx_down_list.php';</script>";	
	  }else{	  
...
<form name="askform" method="post" onSubmit="if(document.askform.w_title.value==''){alert('标题为空');document.askform.w_title.focus();return false;}if(document.askform.pb_pindao.value==''){alert('请选择频道');document.askform.pb_pindao.focus();return false;}if(document.askform.w_con.value==''){alert('请上传资料');document.askform.w_con.focus();return false;}" action="">
  <tr>
	...
	<td width="766" colspan="-2" bgcolor="#FFFFFF" class="title"><input type="text" name="down_title" id="w_title" value="" maxlength="40" style="width:200px;"/><span id="ntil">*</span></td>
    </tr>
	  <tr>
