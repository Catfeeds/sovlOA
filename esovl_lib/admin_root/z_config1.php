...
//echo $_POST["z_name"];
$sql="update web_step set z_pic1='".$_POST["z_pic1"]."',z_link1='".$_POST["z_link1"]."',z_pic2='".$_POST["z_pic2"]."',z_link2='".$_POST["z_link2"]."',z_pic3='".$_POST["z_pic3"]."',z_link3='".$_POST["z_link3"]."',z_pic4='".$_POST["z_pic4"]."',z_link4='".$_POST["z_link4"]."',z_pic5='".$_POST["z_pic5"]."',z_link5='".$_POST["z_link5"]."',z_pic6='".$_POST["z_pic6"]."',z_link6='".$_POST["z_link6"]."' where z_id=0";
...
//			echo mysql_error();
		...
		$sql="select z_pic1,z_link1,z_pic2,z_link2,z_pic3,z_link3,z_pic4,z_link4,z_pic5,z_link5,z_pic6,z_link6 from web_step where z_id=0";
		$rs=mysql_query($sql,$conn);
...
<div class="mian_right">
            ...
            <div class="mian_right_box00">
            	<div class="mian_right_box_title">
                	...
                	<div class="mian_right_box_title_02"><a href="z_website.php">基本信息</a> | <a href="z_cpinfo.php">公司信息</a> | <a href="z_guanggao.php">广告专栏</a> | <a href="z_indexpic.php">首页图片轮播</a></div>
                </div>
                	...
                	<div class="mian_right_box_list00">
                    	<div class="mian_right_box_list_title">
                            ...
                            <dt><img src="images/right_left01bg.jpg" /></dt>
                       	    <dd style="float:left; background:#fff; margin-left:0px;">首页幻灯图片设置</dd>
...
<input  type="button" class="go" onclick="window.open('up2.php?formname=formset&editname=z_pic1&uppath=upload','','status=no,scrollbars=no,top=400,left=500,width=420,height=165')" value="上传图片1" />
                                <span id="pc1">*</span><span style="color:#999"> 尺寸(px)：551x275</span>
							...
							<tr>
                              ...
                              <td width="917" bgcolor="#FFFFFF"><input type="text" name="z_pic2" value="<?php echo $z_pic2;?>" style="width:210px;" readonly/>
                                ...
                                <span id="pc2">*</span><span style="color:#999"> 尺寸(px)：551x275</span>
							...
							<tr>
                              ...
                              <td width="917" bgcolor="#FFFFFF"><input type="text" name="z_pic3" value="<?php echo $z_pic3;?>" style="width:210px;" readonly/>
                                ...
                                <span id="pc3">*</span><span style="color:#999"> 尺寸(px)：551x275</span>
							...
							<tr>
                              ...
                              <td width="917" bgcolor="#FFFFFF"><input type="text" name="z_pic4" value="<?php echo $z_pic4;?>" style="width:210px;" readonly/>
                                ...
                                <span id="pc4">*</span><span style="color:#999"> 尺寸(px)：551x275</span>
							...
							<tr>
                              ...
                              <td width="917" bgcolor="#FFFFFF"><input type="text" name="z_pic5" value="<?php echo $z_pic5;?>" style="width:210px;" readonly/>
                                ...
                                <span id="pc5">*</span><span style="color:#999"> 尺寸(px)：551x275</span>
							...
							<tr>
                              ...
                              <td width="917" bgcolor="#FFFFFF"><input type="text" name="z_pic6" value="<?php echo $z_pic6;?>" style="width:210px;" readonly/>
                                ...
                                <span id="pc6">*</span><span style="color:#999"> 尺寸(px)：551x275</span>
