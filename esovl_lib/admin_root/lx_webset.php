...
$sql="update web_step set z_name='".$_POST["z_name"]."',z_title='".$_POST["z_title"]."',z_keyword='".$_POST["z_keyword"]."',z_contant='".$_POST["z_contant"]."',z_banner='".$_POST["z_banner"]."',z_onegg='".$_POST["z_onegg"]."',z_tel='".$_POST["z_tel"]."',z_qq='".$_POST["z_qq"]."',z_right1='".$_POST["z_right1"]."',z_right2='".$_POST["z_right2"]."',z_right3='".$_POST["z_right3"]."',z_logo='".$_POST["z_logo"]."' where z_id=12";
...
//			echo mysql_error();
		...
		$sql="select * from web_step where z_id=12";
		$rs=mysql_query($sql,$conn);
            ...
            <div class="mian_right_box00">
                ...
                <div class="mian_right_box_list">
                	<div class="mian_right_box_list00">
                    	<div class="mian_right_box_list_title">
                            ...
                            <dt><img src="images/right_left01bg.jpg" /></dt>
                       	    <dd style="float:left; background:#fff; margin-left:0px;">留学基本信息</dd>
                        ...
                        <div class="mian_right_box_list_text">
						  ...
						  <form id="formset" name="formset" method="post" onsubmit="return webset()" action="">
                            ...
                            <tr>
                              <td align="right" bgcolor="#FFFFFF">咨询报名热线：</td>
                              <td bgcolor="#FFFFFF"><input type="text" name="z_tel" value="<?=$z_tel?>"/></td>
                            </tr>
                   ...
                   <span style="color:#999"> 多个QQ请用逗号隔开,请至少填写2个号码！</span></td>
                            ...
                            <tr>
                              <td align="right" bgcolor="#FFFFFF">留学首页广告一：</td>
                              <td bgcolor="#FFFFFF"><?php
							   $oFCK->Value  = $z_onegg;
							   $oFCK->Create();
							   ?></td>
							 ...
							 <tr>
                              <td align="right" bgcolor="#FFFFFF">留学新闻广告：</td>
                              <td bgcolor="#FFFFFF"><?php
                            ...
                            <tr>
                              <td align="right" bgcolor="#FFFFFF">新闻报名流程图：</td>
                              <td bgcolor="#FFFFFF"><?php
                            ...
                            <tr>
                              <td align="right" bgcolor="#FFFFFF">留学首页广告四：</td>
                              <td bgcolor="#FFFFFF"><?php
