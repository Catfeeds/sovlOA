...
//echo $_POST["z_name"];
$sql="update web_step set z_pic1='".$_POST["z_pic1"]."',z_link1='".$_POST["z_link1"]."',z_pic2='".$_POST["z_pic2"]."',z_link2='".$_POST["z_link2"]."',z_pic3='".$_POST["z_pic3"]."',z_link3='".$_POST["z_link3"]."',z_pic4='".$_POST["z_pic4"]."',z_link4='".$_POST["z_link4"]."',z_pic5='".$_POST["z_pic5"]."',z_link5='".$_POST["z_link5"]."',z_pic6='".$_POST["z_pic6"]."',z_link6='".$_POST["z_link6"]."' where z_id=12";
...
//			echo mysql_error();
		...
		$sql="select z_pic1,z_link1,z_pic2,z_link2,z_pic3,z_link3,z_pic4,z_link4,z_pic5,z_link5,z_pic6,z_link6 from web_step where z_id=12";
		$rs=mysql_query($sql,$conn);
...
<div class="mian_right">
            ...
            <div class="mian_right_box00">
            	<div class="mian_right_box_title">
                    <div class="mian_right_box_title_01">留学基本信息设置</div>
                	...
                	<div class="mian_right_box_list00">
                    	<div class="mian_right_box_list_title">
                            ...
                            <dt><img src="images/right_left01bg.jpg" /></dt>
                       	    <dd style="float:left; background:#fff; margin-left:0px;">留学幻灯图片设置</dd>
