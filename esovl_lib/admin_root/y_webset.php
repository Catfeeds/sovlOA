...
$sql="update yx_step set yx_name='".$_POST["yx_name"]."',yx_title='".$_POST["yx_title"]."',yx_Keyword='".$_POST["yx_Keyword"]."',yx_Description='".$_POST["yx_Description"]."',yx_qq='".$_POST["yx_qq"]."',yx_logo='".$_POST["yx_logo"]."',yx_gg='".$_POST["yx_gg"]."' where yx_id=1";
 //  exit($sql);
