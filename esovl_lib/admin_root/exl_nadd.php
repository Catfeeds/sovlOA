...
if ($mid==""){
  ...
  if (isset($_POST["ntitle"])){
      $sql="insert into ennews set nclass=".$_POST["nclass"].",ntitle='".$_POST["ntitle"]."',ncon='".$_POST["ncon"]."',nbool=".$_POST["nbool"].",ndate='".$_POST["ndate"]."',ntype='$mid',npic='".$_POST["npic"]."'";
...
<table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#3e70a5" class="tableborder">
  <tr>
    <th height="24" nowrap="nowrap"><div class="mian_right_box_title_01" style="text-align:left;">学历版新闻信息：添加，修改介绍新闻相关的内容</div></th>
  </tr>
  <tr>
    <td height="24" align="center" nowrap="nowrap" bgcolor="#e7ebe7"  class="forumrow"><a href="exl_nadd.php?id=<?=$mid?>">添加新闻信息</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="exl_nlist.php?id=<?=$mid?>" >查看新闻信息</a><font color="#0000FF">&nbsp;</font></td>
  </tr>
</table>
<br>
<div class="s_info">
...
<form name="formnews" method="post" onSubmit="return newsset()" action="">
  <tr>
    <td colspan="5" class="mian_right_box_title_01">【添加学历版新闻信息】</td>
	</tr> 
	<tr>
