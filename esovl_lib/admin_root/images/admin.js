...
var d = document;
 function openbox_01() {
	 d.getElementById("left_box01").style.display="none";
     d.getElementById("gb01").style.display="block";
	 d.getElementById("xs01").style.display="none";
	}
	
 function openbox_02() {
	 d.getElementById("left_box01").style.display="block";
	 d.getElementById("gb01").style.display="none";
	 d.getElementById("xs01").style.display="block";
	}