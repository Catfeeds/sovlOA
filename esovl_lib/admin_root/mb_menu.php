...
<?php echo"<script>window.parent.frames[1].location.href='xl_mbset.php';</script>";?>
...
<div class="mian_left">
           <div class="mian_left_box01">
        	...
        	<dl>
        	<dd style="width:200px;"><span style="color:yellow;"><b><?php echo $_SESSION['mbsname'];?></b></span></dd>
        	</dl>
            </div>
            <div class="mian_left_box01_00">
...
<tr>
    <td><a href="xl_mbset.php" target="frmright">模板配置信息</a></td>
</tr>
<tr>
    <td><a href="xl_mbinfo.php" target="frmright">学校信息设置</a></td>
</tr>
<td> <a href="select_school.php" target="frmright">设置其他学校</a></td>
...
<table width="137" border="0">
  <tr>
    <td><a href="mb_nclass.php" target="frmright">文章分类</a></td>
    </tr>
  <tr>
    <td><a href="mb_nlist.php" target="frmright">信息列表</a></td>
    </tr>  
  <tr>
    <td><a href="mb_nadd.php" target="frmright">信息添加</a></td>
  </tr>
</table>
            </div>
            </div>
...
<div class="mian_left_box01_00">
            <dl><dt><img src="images/ico01.jpg" /></dt><dd><a href="javascript:void(null)" onClick="javascript:left_menu('box_list14');">资料下载</a></dd></dl>
            <div class="box_list" id="box_list14" style="display:none;">
<table width="137" border="0">
  <tr>
    <td><a href="mb_down_list.php" target="frmright">下载资料列表</a></td>
    </tr>
	<tr>
    <td><a href="mb_down_add.php" target="frmright">添加下载资料</a></td>
    </tr>  
</table>
            </div>
            </div>
			...
			<div class="mian_left_box01_00">
            <dl><dt><img src="images/ico01.jpg" /></dt><dd><a href="javascript:void(null)" onClick="javascript:left_menu('box_list05');">师生风采</a></dd></dl>
            <div class="box_list" id="box_list05" style="display:none;">
<table width="137" border="0">
<tr>
    <td><a href="mb_tslist.php" target="frmright">风采管理</a></td>
</tr>
<tr>
    <td><a href="mb_tsadd.php" target="frmright">风采添加</a></td>
</tr>
</table>
            </div>
            </div>
