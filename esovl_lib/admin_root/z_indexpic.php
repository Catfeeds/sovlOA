...
<div class="mian_right">
            ...
            <div class="mian_right_box00">
                ...
                <div class="mian_right_box_list">
                   ...
                   <td bgcolor="#FFFFFF"><input type="text" name="z_qq" onkeyup="value=value.replace(/[^\d]/g,'')" value="<?php echo $z_qq;?>" maxlength="12"/><span style="color:#999"> 多个QQ请用逗号隔开</span></td>
                            </tr>
                            <tr>
