...
function lxnewsset(){//lx-news
	
	if(document.lxnform.lx_gjcl.value=="0"){
	document.getElementById("lxgjcl").innerHTML="<font color=red>&times;请选择国家分类!</font>";
	document.lxnform.lx_gjcl.focus();
	return false;
	}else{
		  document.getElementById("lxgjcl").innerHTML="<font color=green><b>√</b></font>";
		  }		  	

   if(document.lxnform.lx_ntitle.value==""){
	document.getElementById("lxntitle").innerHTML="<font color=red>&times;请填写新闻标题!</font>";
	document.lxnform.lx_ntitle.focus();
    return false;
	}else{
	document.getElementById("lxntitle").innerHTML="<font color=green><b>√</b></font>";
	} 
}

function lxsdset(){//lx-news
	//document.getElementById("lx_sdbcl").style.cssText="color:#c2d3fc;";	
	if(document.lxsdform.lx_sdbcl.value=="0"){
	document.getElementById("lxd").innerHTML="<font color=red>×</font>";
	document.lxsdform.lx_sdbcl.focus();
	return false;
	}	  	

   if(document.lxsdform.lx_sdtitle.value==""){
	document.getElementById("lxsdtitle").innerHTML="<font color=red>&times;请填写视点新闻标题!</font>";
	document.lxsdform.lx_sdtitle.focus();
    return false;
	}else{
	document.getElementById("lxsdtitle").innerHTML="<font color=green><b>√</b></font>";
	} 
}
...
function getshow(){
	document.getElementById("get_msjz_date").style.display="inline";
	}
function gethide(){
	document.getElementById("get_msjz_date").style.display="none";
	}	