...
if (@$_COOKIE["a_class"]>1) {
  ...
  if (isset($_POST["bm_id"])){ 
      ...
      $sql="update wsbm set bm_bool=".$_POST["bm_bool"]." where bm_id=".$_POST["bm_id"];
	  $rs=mysql_query($sql,$conn);
	  if ($rs){
	
      echo"<script>alert('修改成功');location.href='bm_list.php';</script>";	  
	  }else{
      ...
      $sql="select * from wsbm where bm_id=".$_GET["id"];
	  $rs=mysql_query($sql,$conn);
	  if (!$rs){	 
  ...
  <table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#93B3E9">
    <form name="formnews" method="post" action="">
      ...
      <tr>
        ...
        <td width="806" bgcolor="#FFFFFF" class="title" style="padding-left:12px;"><?php echo $row["bm_name"];?>
      ...
      <tr>
        ...
        <td width="806" bgcolor="#FFFFFF" class="title" style="padding-left:12px;"><?php echo $row["bm_xxname"];?></td>
      </tr>
      <tr>
        <td height="38" colspan="4" align="right" bgcolor="#FFFFFF" class="title">专业类别：</td>
        <td width="806" bgcolor="#FFFFFF" class="title" style="padding-left:12px;"><?php echo $row["bm_zyclass"];?></td>
      </tr>
      <tr>
        <td height="35" colspan="4" align="right" bgcolor="#FFFFFF" class="title">专业名称：</td>
        <td bgcolor="#FFFFFF" class="title" style="padding-left:12px;"><?php echo $row["bm_zycaption"];?></td>
      </tr>
      <tr>
        <td height="40" colspan="4" align="right" bgcolor="#FFFFFF" class="title">联系电话：</td>
        <td bgcolor="#FFFFFF" class="title" style="padding-left:12px;"><?php echo $row["bm_tel"];?></td>
      </tr>
      <tr>
        <td height="36" colspan="4" align="right" bgcolor="#FFFFFF" class="title">电子邮箱：</td>
        <td bgcolor="#FFFFFF" class="title" style="padding-left:12px;"><?php echo $row["bm_email"];?></td>
      </tr>
      <tr>
        <td height="34" colspan="4" align="right" bgcolor="#FFFFFF" class="title">地　　址：</td>
        <td bgcolor="#FFFFFF" class="title" style="padding-left:12px;"><?php echo $row["bm_address"];?></td>
      </tr>
      <tr>
        <td height="40" colspan="4" align="right" bgcolor="#FFFFFF" class="title">身分证号：</td>
        <td bgcolor="#FFFFFF" class="title" style="padding-left:12px;"><?php echo $row["bm_sfz"];?></td>
      </tr>
      <tr>
        <td height="44" colspan="4" align="right" bgcolor="#FFFFFF" class="title">备　　注：</td>
        <td bgcolor="#FFFFFF" class="title" style="padding-left:12px;"><?php echo $row["bm_con"];?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF" class="title" style="padding-left:12px;"><?php echo $row["bm_date"];?></td>
      </tr>
      <tr>
