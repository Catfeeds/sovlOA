...
<title><?php echo $class_title;?>企培新闻列表</title>
...
<li class="t_wz">您现在的位置：<a href="http://<?php echo $_SERVER['SERVER_NAME'];?>">一休网</a> > <a href="../Enterprise">企培频道</a> > <a href="qp_new_list2.php"><strong>新闻中心</strong></a></li>
                    </ul>
              	</div>
...
$page.=',';
     ...
     $i=$i+1;	 
?>  
<dl><dt><a href="qp_new_detial.php?cl=<?php echo $row["news_id"];?>"><?php echo utf_substr($row["news_title"],100);?></a></dt><dd><?php echo $row["ndate"];?></dd></dl>
<?php }}?>
                </div>
...
?></span>页，共<span><?php echo $cp;?></span>页，每页<span><?php echo $pagesize;?></span>条。
                     </dd>
                    </dl>
                </div>
            </div>
