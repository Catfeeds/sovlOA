...
<div class="main">
	...
	<div class="px_weizhi">你现在的位置：<a href="index.php">培训</a> >> <a href="px_shop.php">上海培训超市</a> >> 全部培训学校
    </div>
    <div class="px_shop">
    	 <div class="px_shop_left">
         	<div class="px_shop_left_box">
       	    <div class="px_shop_left_box00">
				 ...
				 foreach($res as $row){?>
       	              <li><a href="px_shop.php?pxk_sid=<?=$row["pxs_id"]?>"><?=$row["pxs_name"]?></a></li>
       	         <?php }?>     
   	                </ul>
     	            </div></td>
   	            </tr>
        ...
        <div class="px_shop_line">&nbsp;</div>
			  ...
			  <?php  
				...
				foreach($res as $row4){?>
                          <li><a href="px_shop.php?pxk_cl=<?=$row4["ps_id"]?>"><?=$row4["ps_title"]?></a></li>
              <?php }?>
              </ul>
              </div>
                    </td>
...
<div class="px_shop_left_box03_00_list_text">
 ...
 <?php }?>
            ...
            <div class="px_shop_left_box04"><?php
				//echo "共".$cp."页";
if($num > $pagesize){
         ...
         <div class="px_shop_right">
			...
			foreach($res as $rowc){?>
                	  ...
                	  <div class="main_shop_fl_list">
                          <ul>
						<?php
                        $res1 = $dblink->findAll('pxsclass','',"pb_id=".$rowc["pb_id"]);
						foreach($res1 as $row1){
                        ?>
                            <li><a href="px_kc_list.php?pid=<?=$row1["ps_id"]?>"><?=$row1["ps_title"]?></a></li>
                          <?php }?>
                        </ul>
                      </div>
                    <?php }?>
