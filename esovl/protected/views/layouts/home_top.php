...
<input type="text" id="inputer" name="school_key" Oninput="userXMLHttp(this.value)" Onpropertychange="userXMLHttp(this.value)" onkeydown="if(event.keyCode==32) return false" />
	...
	<div class="top_nav_box01">
        ...
        <div class="top_nav_box01_list01" id="nav_tb_">
        	<ul>
            	<li id="nav_tb_1" class="nav_normaltab" onmouseover="navHoverLi(1);" onmouseout="navnoHoverLi();"><h1><a target="_blank" href="/Education/index">学历</a></h1></li>
                <li id="nav_tb_2" class="nav_normaltab" onmouseover="navHoverLi(2);" onmouseout="navnoHoverLi();"><h1><a target="_blank" href="/Training/">培训</a></h1></li>
                <li id="nav_tb_3" class="nav_normaltab" onmouseover="navHoverLi(3);" onmouseout="navnoHoverLi();"><h1><a target="_blank" href="/Research/">研修</a></h1></li>
                <li class="nav_normaltab"><h1><a target="_blank" href="/Abroad/">留学</a></h1></li>
                <li class="nav_normaltab"><h1><a target="_blank" href="/Enterprise">企培</a></h1></li>
                <li class="nav_normaltab"><h1><a target="_blank" href="/news.php">资讯</a></h1></li>
                <li class="nav_normaltab"><h1><a target="_blank" href="/bbs/">社区</a></h1></li>
                <!-- <li class="nav_normaltab"><h1><a href="javascript:void(null);">人才</a></h1></li>-->
            </ul>
        </div>
    </div>
    <div class="top_nav_box02">
        ...
        <div class="top_nav_box02_box02">
        	<div class="nav_undis" id="nav_tbc_01">
            	<a target="_blank" href="<?=Yii::app()->createUrl("/education/index")?>">学历教育</a>
                <a target="_blank" href="<?=Yii::app()->createUrl("/education/zxksindex")?>">自学考试</a>
                <a target="_blank" href="<?=Yii::app()->createUrl("/education/wlyxindex")?>">网络院校</a>
                <a target="_blank" href="<?=Yii::app()->createUrl("/education/crgkindex")?>">成人高考</a>
                <a target="_blank" href="<?=Yii::app()->createUrl("/education/gjbxindex")?>">国际办学</a>
                <a target="_blank" href="<?=Yii::app()->createUrl("/education/gxjzindex")?>">高校简章</a>
                <a target="_blank" href="<?=Yii::app()->createUrl("/education/jzsearch")?>">简章搜索</a>
                <a target="_blank" href="<?=Yii::app()->createUrl("/education/gfbindex")?>">高复班</a>
            </div>
