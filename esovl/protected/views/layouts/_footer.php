...
<div class="bottom">
  <div class="bottom_box01">
    <div class="main_box06_top"><img src="http://<?php echo $_SERVER['SERVER_NAME'];?>/images/bottom_bg_top.jpg" /></div>
              ...
              <div id="indemo">
                <div id="demo1">
                  <?php
						...
						?>
						  <li class="dw"><a href="<?php echo $row['hz_link']?>"><img src="http://<?php echo $_SERVER['SERVER_NAME'];?>/admin_root/<?php echo $row['hz_logo']?>" /></a></li>
						  <?php
						}
						?>
                </div>
  ...
  <div class="bottom_box02">
    ...
    <div class="bottom_box02_02">
      <div class="bottom_box02_02_nav">
        <?php
			$rs=Cpinfo::model()->findAll("cp_id<>10");
			foreach($rs as $k=>$row){
		?>
        <a href="about.php?cid=<?=$row["cp_id"]?>">
        <?=$row["cp_title"]?>
        </a><?php if ($k+1!==count($rs)){?><span>-</span>
        <?php }
		}
		?>
      </div>
