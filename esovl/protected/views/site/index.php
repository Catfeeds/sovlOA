<?php
// Yii::app()->clientScript->registerMetaTag("123321",'keywords');
// Yii::app()->clientScript->registerMetaTag("333",'description');
							...
							<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" >
								<tr>
									...
									<?php
										...
										$row=Ennews::model()->find($criteria);
									?>
									<a href="/Training/px_news_list_details.php?id=<?php echo $row["nid"];?>">
										<img src="/admin_root/<?php echo $row['npic'];?>" onLoad="javascript:if(this.width>=this.height&&this.width>=88){this.width=88};if(this.height>this.width&&this.height>=98){this.height=98};" border="0" align="top" />
									</a>
									</td>
								</tr>
							</table>
                    ...
                    <div class="main_box04_box_left_box01_list_text">        
						<dl>
							<dt>
								<span>■</span>
								<a href="/Training/px_news_list_details.php?id=<?php echo $row["nid"];?>">
									<?=Common::strCut($row["ntitle"],45);?>
								</a>
								
							</dt>
							<dd><?=Common::strCutAndTags($row['ncon'],76);?></dd>
                        </dl>
                        <h1>
							<?php
							$criteria=new CDbCriteria;
                ...
                <div class="main_box04_box_left_box01_list">
							...
							<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" >
								<tr>
									...
									<?php
										...
										$row=QpNews::model()->find($criteria);?>
										<a href="Enterprise/qp_new_detial.php?cl=<?php echo $row["news_id"];?>"><img src="/admin_root/<?php echo $row["npic"];?>"  onLoad="javascript:if(this.width>=this.height&&this.width>=88){this.width=88};if(this.height>this.width&&this.height>=98){this.height=98};"  border="0" align="top" /></a>
									</td>
								</tr>
							</table>
						</div>
					...
					<div class="main_box04_box_left_box01_list_text">
						<dl>
							<dt>
								<span>■</span>
								<a href="Enterprise/qp_new_detial.php?cl=<?php echo $row["news_id"];?>">
									<?=Common::strCut($row["news_title"],28);?>
								</a>
							</dt>
							<dd><?=Common::strCutAndTags($row["news_con"],72);?></dd>
						</dl>
						<h1>
							<ul>
							<?php
                ...
                <div class="main_box04_box_left_box01_list_left">
                    ...
                    <div class="main_box04_box_left_box02_list_text">
						...
						<?php
							...
							foreach($rs as $row){?>
								<li><span>[<?php echo $row["zyclass"];?>]</span><a href="Education/xl_pro_detail.php?kid=<?=$row["kid"]?>&sid=<?=$row["s_id"]?>"><?php echo Common::strCut($row["ktitle"],20);?></a></li>
						<?php }?>
                        </ul>
                    </div>
                </div>
