...
<table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#3e70a5" class="tableborder">
  <tr>
    <th height="24" colspan="3" nowrap="nowrap"><div class="mian_right_box_title_01" style="text-align:left;">学历版新闻信息：添加，修改资讯相关的内容</div></th>
  </tr>
  <tr>
    <td width="54%" height="24" align="center" nowrap="nowrap" bgcolor="#e7ebe7"  class="forumrow"><a href="exl_nadd.php?id=<?php echo $mid;?>">添加新闻信息</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="exl_nlist.php?id=<?php echo $mid;?>" >查看新闻信息</a><font color="#0000FF">&nbsp;</font></td>
...
<form action="" method="post" name="formDel">
  ...
  <tr>
	...
	<td width="499" bgcolor="#FFFFFF" class="title"><a href="exl_nedit.php?id=<?php echo $row["nid"];?>&mid=<?=$mid?>"><?php echo $row["ntitle"];?></a></td>
	...
	<td width="128" align="center" bgcolor="#FFFFFF" class="title"><a href="exl_nedit.php?id=<?php echo $row["nid"];?>&mid=<?php echo $mid;?>">修改</a> <a href="exl_nlist.php?del=ok&mid=<?php echo $mid;?>&id=<?php echo $row["nid"]?>" onClick="return confirm('是否将此信息删除?')">删除</a></td>
	</tr>
  <?php
   }
  }
