...
<!--#include file="io.php"-->
<!--#include file="basexml.php"-->
<!--#include file="commands.php"-->
<!--#include file="class_upload.php"-->
<%

If ( ConfigIsEnabled = False ) Then
	SendError 1, "This connector is disabled. Please check the ""editor/filemanager/connectors/asp/config.php"" file"
End If
