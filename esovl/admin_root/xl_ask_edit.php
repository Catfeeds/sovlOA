...
if (@$_COOKIE["a_class"]>1) {
  ...
  if (isset($_POST["w_title"])){ 
      ...
      $sql="update xl_ask set w_title='".$_POST["w_title"]."',w_con='".$_POST["w_con"]."' where w_id=".$_POST["w_id"];
	  $rs=mysql_query($sql,$conn);
	  if ($rs){
	
      echo"<script>alert('修改成功');location.href='xl_ask_list.php';</script>";	  
	  }else{
...
<table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#3e70a5" class="tableborder">
  <tr>
    <th height="24" nowrap="nowrap"><div class="mian_right_box_title_01" style="text-align:left;">常见问题：添加，修改介绍企业相关的内容</div></th>
  </tr>
  <tr>
...
<div class="s_info">
  <table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#93B3E9">
    <form name="askform" method="post" onSubmit="if(document.askform.w_title.value==''){alert('标题为空');document.askform.w_title.focus();return false;}" action="">
      <tr>
        <td colspan="2" class="mian_right_box_title_01">【编辑常见问题】</td>
      </tr>
      <tr>
        <td height="38" align="right" bgcolor="#FFFFFF" class="title">信息标题：</td>
        <td width="919" colspan="-2" bgcolor="#FFFFFF" class="title"><input name="w_id" value="<?php echo $_GET["id"];?>"type="hidden"><input type="text" name="w_title" id="w_title" value="<?php echo $row["w_title"]?>" maxlength="40" style="width:300px;"/>
