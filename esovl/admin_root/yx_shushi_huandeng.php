...
//			echo mysql_error();
		...
		$sql="select hd_pic1,hd_link1,hd_pic2,hd_link2,hd_pic3,hd_link3,hd_pic4,hd_link4,hd_title1,hd_title2,hd_title3,hd_title4 from yx_hd where hd_id=3";
		$rs=mysql_query($sql,$conn);
