...
if (isset($_POST["news_title"])){
	$sql="insert into yx_news set class_name=".$_POST["class_name"].",kaoshi_title='".$_POST["kaoshi_title"]."',news_title='".$_POST["news_title"]."',news_con='".$_POST["news_con"]."',nbool=".$_POST["nbool"].",ndate='".$_POST["ndate"]."',news_class='MBA/EMBA',npic='".$_POST["npic"]."'";
...
<select name="class_name"><option value=0>--选择新闻分类--</option>
<?php 
...
<span id="p_pxlb">*</span></td>
	  </tr>
      <td height="40" colspan="4" align="right" bgcolor="#FFFFFF" class="title">选择新闻分类</td>
        <td width="919" bgcolor="#FFFFFF" class="title" style="padding-left:12px;">   
<select name="kaoshi_title">
 <option value="0">--选择新闻小类--</option>
<?php 
...
while ($row=mysql_fetch_array($rs,MYSQL_ASSOC)){
?>			
          <option value="<?php echo $row["kaoshi_title"]?>"><?php echo $row["kaoshi_title"]?></option>
<?php }}?>          
</select>
<span id="p_pxlb">*</span></td>
<tr>
