...
//echo $_POST["z_name"];
$sql="update yx_hd set hd_pic1='".$_POST["hd_pic1"]."',hd_link1='".$_POST["hd_link1"]."',hd_pic2='".$_POST["hd_pic2"]."',hd_link2='".$_POST["hd_link2"]."',hd_pic3='".$_POST["hd_pic3"]."',hd_link3='".$_POST["hd_link3"]."',hd_pic4='".$_POST["hd_pic4"]."',hd_title1='".$_POST["hd_title1"]."',hd_title2='".$_POST["hd_title2"]."',hd_title3='".$_POST["hd_title3"]."',hd_title4='".$_POST["hd_title4"]."',hd_link4='".$_POST["hd_link4"]."' where hd_id=2";
...
//			echo mysql_error();
		...
		$sql="select hd_pic1,hd_link1,hd_pic2,hd_link2,hd_pic3,hd_link3,hd_pic4,hd_link4,hd_title1,hd_title2,hd_title3,hd_title1,hd_title4 from yx_hd where hd_id=2";
		$rs=mysql_query($sql,$conn);
