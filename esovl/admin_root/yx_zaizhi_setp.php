...
if (isset($_POST["yx_title"])){
//echo $_POST["z_name"];
$sql="update yx_step set yx_title='".$_POST["yx_title"]."',yx_Keyword='".$_POST["yx_Keyword"]."',yx_Description='".$_POST["yx_Description"]."',yx_qq='".$_POST["yx_qq"]."',yx_logo='".$_POST["yx_logo"]."',yx_gg='".$_POST["yx_gg"]."' where yx_id=4";
 //  exit($sql);
...
//			echo mysql_error();
		...
		$sql="select * from yx_step where yx_id=4";
		$rs=mysql_query($sql,$conn);
                        ...
                        <div class="mian_right_box_list_text">
						  ...
						  <form id="formset" name="formset" method="post" onsubmit="return webset()" action="">
                            <tr>
                              ...
                              <td width="917" bgcolor="#FFFFFF"><input type="text" name="yx_title" id="z_title" value="<?php echo $yx_title;?>" maxlength="140" style="width:300px;"/>
